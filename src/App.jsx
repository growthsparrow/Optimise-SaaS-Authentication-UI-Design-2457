...
import PublicAppointmentBooking from './components/PublicAppointmentBooking';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/:businessSlug/book" element={<PublicAppointmentBooking />} />
        <Route path="/book/:businessSlug/appointments" element={<PublicAppointmentBooking />} />
