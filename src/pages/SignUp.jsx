...
function SignUp() {
  ...
  const handleSubmit = async (event) => {
    ...
    setNotice('Your account has been created. Please sign in to continue.');
  };
    ...
    <AuthShell alternateText="Already have an account?" alternateLabel="Sign in" alternateTo="/">
      ...
      <form className="auth-form auth-form--signup" onSubmit={handleSubmit}>
        ...
        <label className="consent">
          ...
          <span>
            I agree to the <Link to="/terms">Terms of use</Link> and acknowledge the <Link to="/privacy">Privacy policy</Link>.
          </span>
        </label>
